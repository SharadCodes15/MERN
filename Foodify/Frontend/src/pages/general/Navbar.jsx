...
export default function Navbar({ showNavbar, onLogout }) {
  ...
  return (
    <Link
      ...
      className="dynamic-island pointer-events-auto absolute left-1/2 top-4 z-20 flex h-10 -translate-x-1/2 items-center gap-2 rounded-full border border-white/25 bg-black/45 px-4 text-white shadow-lg backdrop-blur-xl"
    >
      <span className="text-xs font-medium tracking-[0.12em]">Home</span>
    </Link>
  );
}
